...
- Fixed the Round 2+ `next_round_ready` lifecycle deadlock that left eligible players on “Loading game…”.
- Improved Realtime notices for joins, submissions, completed rounds, and automatically ready rounds.

### Added

- Responsive round-result cards comparing every player's stored circle, fitted overlay, rank, rating, and score.
